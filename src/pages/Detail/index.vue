          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in  spuSaleAttrList" :key="saleAttr.id">
                ...
                v-for="value in saleAttr.spuSaleAttrValueList" :key="value.id"
                @click="changeChecked(value,saleAttr.spuSaleAttrValueList)">
...
export default {
  ...
  //一般在beforeMount当中处理数据，处理完成以后就可以直接使用
  beforeMount() {
    this.skuId = this.$route.params.skuId; //在挂载之前把这个数据存起来
  },
  mounted() {
    this.getDetailInfo();
  },
